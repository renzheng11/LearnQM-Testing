...
let E_conduction = [
	124, 130, 135, 140, 143.3333333, 146.6666667, 150, 152.5, 155, 157.5, 160,
	162, 164, 166, 168, 170, 171.6666667, 173.3333333, 175, 176.6666667,
	178.3333333, 180, 181.4285714, 182.8571429, 184.2857143, 185.7142857,
	187.1428571, 188.5714286, 190, 191.25, 192.5, 193.75, 195, 196.25, 197.5,
	198.75, 200,
];
...
let waveToPix = d3.scaleLinear().domain([0, 1.1]).range([0, 60]);

let diff = 0,
	diff1 = 0;

d3fourlevels = () => {
	(heightD3 = 500), (widthD3 = 300);
	...
	let xAxis = d3.axisBottom().scale(xScale).tickValues([]);

	let yAxis = d3.axisLeft().scale(yScale).tickValues([]);
	...
	for (let i = 1; i <= orbitalCount; i++) {
		d3.select("#d3-viz")
			...
			.on("mouseover", function () {
				...
				d3.selectAll("#band-gap").attr("opacity", 0);
			})
			.on("mouseout", function () {
				...
				d3.selectAll("#band-gap").attr("opacity", 1);
			});
...
bringElecBackD3 = () => {
	d3.select("#d3-viz7").selectAll(".current-electron").remove();

	d3.select("#d3-viz7").selectAll("#hole").remove();
};
...
d3bands = () => {
	...
	svg_1.append("path").attr("id", "area");
	...
	svg_1.append("circle").attr("id", "circle_1_2").attr("stroke", "#EA9FA2");

	svg_1.append("circle").attr("id", "circle_2_2").attr("stroke", "#EA9FA2");

	svg_1.append("circle").attr("id", "circle_1_2_up").attr("stroke", "#EA9FA2");

	svg_1.append("circle").attr("id", "circle_2_2_up").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_1_2").attr("stroke", "#EA9FA2");

	svg_1.append("text").attr("id", "text_1_2");

	svg_1.append("text").attr("id", "text_1_2_e");

	svg_1.append("text").attr("id", "text_1_2_hh");

	svg_1.append("line").attr("id", "line_s1").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_s1_u").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_s1_d").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_s2").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_s2_u").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_s2_d").attr("stroke", "#EA9FA2");

	svg_1.append("line").attr("id", "line_1").attr("stroke", "#EA9FA2");

	svg_1.append("text").attr("id", "text_1");

	svg_1.append("text").attr("id", "text_2");

	svg_1.append("text").attr("id", "text_3");

	svg_1.append("text").attr("id", "text_4");

	svg_1.append("text").attr("id", "text_5");

	svg_1.append("text").attr("id", "text_6");

	svg_1.append("text").attr("id", "text_fermi");
	...
	svg_1.append("text").attr("id", "fermi-text");

	for (let i = 0; i < 60; i++) {
		y_circle[i] = "circle_group" + str(i);
		svg_1.append("circle").attr("id", y_circle[i]).attr("stroke", "#EA9FA2");
	}

	for (let i = 0; i < 60; i++) {
		y_line[i] = "line_group" + str(i);
		svg_1.append("line").attr("id", y_line[i]).attr("stroke", "#EA9FA2");
	}
					...
					"# of electrons: " +
						(
							...
							(1 /
								(1 +
									Math.exp(
										y_cordi / 100 / ((0.026 * constant_temperature) / 300)
									)))
						).toExponential(2)
				);
		} else if (y_cordi < 0) {
		...
		if (num_Line_text != 0) {
			for (let i = 0; i < num_Line_text + 1; i++) {
				svg_1
					...
					.attr(
						"y1",
						y_cordi_real - 6 + 0.2 - 0.5 + i * (1 / (num_Line_text + 1))
					)
...
d3bands_2 = () => {
	...
	svg_12.append("line").attr("id", "line_1").attr("stroke", "#EA9FA2");

	svg_12.append("text").attr("id", "text_1");

	svg_12.append("text").attr("id", "text_2_2");

	svg_12.append("text").attr("id", "text_2");

	svg_12.append("text").attr("id", "text_2_e");

	svg_12.append("text").attr("id", "text_3");

	svg_12.append("text").attr("id", "text_4");

	svg_12.append("text").attr("id", "text_5");

	svg_12.append("text").attr("id", "text_6");

	svg_12.append("text").attr("id", "text_fermi");
	...
	d3.selectAll("#d3-viz6-2")
		...
		.text(
			"fermi energy = " +
				Math.round(constant_fermi_positive * 1000) / 1000 +
				" eV"
		);
...
d3bands_0 = () => {
	...
	svg_0.append("circle").attr("id", "circle_1").attr("stroke", "#EA9FA2");

	svg_0.append("circle").attr("id", "circle_2").attr("stroke", "#EA9FA2");

	svg_0.append("line").attr("id", "line_1").attr("stroke", "#EA9FA2");

	svg_0.append("text").attr("id", "text_1");

	svg_0.append("text").attr("id", "text_2");

	svg_0.append("text").attr("id", "text_3");

	svg_0.append("text").attr("id", "text_4");

	svg_0.append("text").attr("id", "text_5");

	svg_0.append("text").attr("id", "text_6");

	svg_0.append("text").attr("id", "text_fermi");
	...
	let yAxis = d3.axisLeft().scale(yScale).tickValues([-100, -56, 0, 56, 100]);
	...
	d3.selectAll("#d3-viz6-0")
		.append("g")
		.call(yAxis)
		.attr("transform", `translate(58,0)`)
		.attr("class", "axis");

	svg_0.append("path").attr("id", "area");
...
d3bands_0_5 = () => {
	...
	svg_0_5.append("circle").attr("id", "circle_1").attr("stroke", "#EA9FA2");

	svg_0_5.append("circle").attr("id", "circle_2").attr("stroke", "#EA9FA2");

	svg_0_5.append("line").attr("id", "line_1").attr("stroke", "#EA9FA2");

	svg_0_5.append("text").attr("id", "text_1");

	svg_0_5.append("text").attr("id", "text_2");

	svg_0_5.append("text").attr("id", "text_3");

	svg_0_5.append("text").attr("id", "text_4");

	svg_0_5.append("text").attr("id", "text_5");

	svg_0_5.append("text").attr("id", "text_6");

	svg_0_5.append("text").attr("id", "text_fermi");
...
d3bands_3 = () => {
	...
	d3.selectAll("#d3-viz6-3")
		.append("g")
		.call(yAxis)
		.attr("transform", `translate(58,0)`)
		.attr("class", "axis");

	svg_3.append("path").attr("id", "area");
	...
	d3.selectAll("#d3-viz6-3")
		...
		.text(
			"fermi energy = " +
				Math.round(constant_fermi_negative * 1000) / 1000 +
				" eV"
		);
	...
	svg_3.append("text").attr("id", "text_1");

	svg_3.append("text").attr("id", "text_2_2");

	svg_3.append("text").attr("id", "text_3");

	svg_3.append("text").attr("id", "line_1");

	svg_3.append("text").attr("id", "text_2");

	svg_3.append("text").attr("id", "text_2_e");

	// svg_1.append('text')
	// .attr('id', 'text_3');

	svg_3.append("text").attr("id", "text_4");

	svg_3.append("text").attr("id", "text_5");

	svg_3.append("text").attr("id", "text_6");

	svg_3.append("text").attr("id", "text_fermi");
...
d3bands_3_1 = () => {
	...
	svg_3_1.append("text").attr("id", "text_1");

	svg_3_1.append("text").attr("id", "text_2_2");

	svg_3_1.append("text").attr("id", "text_3");

	svg_3_1.append("text").attr("id", "line_1");

	svg_3_1.append("text").attr("id", "text_2");

	svg_3_1.append("text").attr("id", "text_2_e");

	// svg_1.append('text')
	// .attr('id', 'text_3');

	svg_3_1.append("text").attr("id", "text_4");

	svg_3_1.append("text").attr("id", "text_5");

	svg_3_1.append("text").attr("id", "text_6");

	svg_3_1.append("text").attr("id", "text_fermi");
